...
describe(
    ...
    () => {
        ...
        it(
            "honors per-action runtimes, spawning one runner each",
            {
                timeout: 90_000,
            },
            async (ctx) => {
        ...
        it(
            "runs an explicit `runtime: bun` now that Bun is confinable",
            {
                timeout: 90_000,
            },
            async (ctx) => {
