...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, p as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, q as renderUniqueStylesheet, t as renderScriptElement, v as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_B9FNj4Lf.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CGcrkeIR.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_CHIEZR6r.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Dzwq9EJQ.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BZbHQNq6.mjs');
...
const starlightConfig = {"social":[{"icon":"github","label":"GitHub","href":"https://github.com/omni-oss/omni"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Guides","translations":{},"collapsed":false,"items":[{"label":"Example Guide","translations":{},"slug":"guides/example","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"autogenerate":{"directory":"reference","attrs":{}}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"titleDelimiter":"|","credits":false,"title":{"en":"My Docs"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///home/runner/work/omni/omni/docs/dev-docs/","srcDir":"file:///home/runner/work/omni/omni/docs/dev-docs/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollectionPathFromRoot as f, getCollection as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, getEntry as l, DEFAULT_HASH_PROPS as m, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
