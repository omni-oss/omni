...
Add filter to clear only cache entries whose task meta configuration matches the given expression, accepts CEL syntax. Only matches tasks present in the current workspace
