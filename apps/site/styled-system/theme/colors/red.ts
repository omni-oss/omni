...
export const red = defineSemanticTokens.colors({
    ...
    subtle: {
        bg: {
            ...
            hover: {
                value: { _light: "{colors.red.a4}", _dark: "{colors.red.a4}" },
            },
            active: {
                value: { _light: "{colors.red.a5}", _dark: "{colors.red.a5}" },
            },
        },
        fg: {
            DEFAULT: {
    ...
    surface: {
        bg: {
            DEFAULT: {
                value: { _light: "{colors.red.a2}", _dark: "{colors.red.a2}" },
            },
            active: {
                value: { _light: "{colors.red.a3}", _dark: "{colors.red.a3}" },
            },
        ...
        border: {
            DEFAULT: {
                value: { _light: "{colors.red.a6}", _dark: "{colors.red.a6}" },
            },
            hover: {
                value: { _light: "{colors.red.a7}", _dark: "{colors.red.a7}" },
            },
        },
        fg: {
            DEFAULT: {
